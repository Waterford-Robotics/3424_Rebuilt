...
public class Constants {
  ...
  public static final class MotorIDConstants {
    ...
    public static final int k_flipoutKrakenID = 40;
  ...
  public static final class IntakeConstants{
   ...
   public static final class IndexerConstants{
    ...
    public static final double k_shooterIndexerSpeed = 0.31;
    public static final double k_beltFloorSpeed = 0.31;
    public static final double k_rollerFloorSpeed = 0.31;
  }
